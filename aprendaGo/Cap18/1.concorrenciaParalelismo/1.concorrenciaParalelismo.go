...
//     - Concorrência é relacionado a fazer seus softwares tem uma ou mais tarefas ao mesmo tempo
//     - Paralelismo é quando você tem mais de um CPU fazendo as tarefas ao mesmo tempo
